...
| `Squeak64-5.3`   | `Pharo64-12`     | `GemStone64-3.5.7`   | `Moose64-9.0`   |                      |
| `Squeak64-5.2`   | `Pharo64-11`     | `GemStone64-3.5.6`   | `Moose64-8.0`   |                      |
| `Squeak64-5.1`   | `Pharo64-10`     | `GemStone64-3.5.5`   | `Moose64-7.0`   |                      |
| `Squeak32-trunk` | `Pharo64-9.0`    | `Gemstone64-3.5.4`   | `Moose32-trunk` |                      |
| `Squeak32-6.0`   | `Pharo64-8.0`    | `GemStone64-3.5.3`   | `Moose32-6.1`   |                      |
| `Squeak32-5.3`   | `Pharo64-7.0`    |                      | `Moose32-6.0`   |                      |
