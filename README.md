...
| `Squeak64-5.2`   | `Pharo64-10`     | `GemStone64-3.3.x`   | `Moose64-9.0`   |
| `Squeak64-5.1`   | `Pharo64-9.0`    | `GemStone64-3.2.x`   | `Moose64-8.0`   |
| `Squeak64-trunk` | `Pharo64-8.0`    | `GemStone64-3.1.0.x` | `Moose64-7.0`   |
| `Squeak32-5.3`   | `Pharo64-7.0`    | `Gemstone64-2.4.x`   | `Moose32-trunk` |
| `Squeak32-5.2`   | `Pharo64-6.1`    |                      | `Moose32-6.1`   |
| `Squeak32-5.1`   | `Pharo64-6.0`    |                      | `Moose32-6.0`   |
